							...
							if (i.player) {
								...
								i.stateHandler.set("loop", function () {
									...
									i.transitionHandler.set("hover", function () {
										i.container.addEventListener("mouseenter", o(i, h)),
											i.container.addEventListener("touchstart", o(i, h), { passive: !0 });
									}),
					...
					h.set(this, {
						...
						value: function () {
							...
							if ("chain" === i.mode) {
								...
								return (
									(i.clickCounter = 0),
									(!e && "click" === n && "click" === t) || ("hover" === n && "hover" === t)
										? i.transitionHandler.get("onComplete").call()
										: i.nextInteraction(),
									i.container.removeEventListener("click", o(i, h)),
									void i.container.removeEventListener("mouseenter", o(i, h))
								);
							}
					...
					g.set(this, {
						...
						value: function () {
							...
							((e && i.player.currentFrame >= e[1]) ||
								...
								(i.holdStatus = !1),
								i.nextInteraction()),
								-1 === i.player.playDirection && e && i.player.currentFrame < e[0] && i.player.pause();
						},
					}),
					w.set(this, {
						writable: !0,
						...
						value: function () {
							...
							"hold" === i.actions[0].type
								...
								: ("pauseHold" !== i.actions[i.interactionIdx].transition &&
										"pauseHold" !== i.actions[i.interactionIdx].state &&
					...
					x.set(this, {
						...
						value: function () {
							if (
								...
								i.container.removeEventListener("mouseenter", o(i, h)),
								i.container.removeEventListener("touchstart", o(i, h)),
								i.container.removeEventListener("touchmove", o(i, v)),
								i.container.removeEventListener("mouseenter", o(i, d)),
								i.container.removeEventListener("touchstart", o(i, d)),
								i.container.removeEventListener("mouseenter", o(i, w)),
					...
					k.set(this, {
						...
						value: function () {
							...
							if (
								...
								if (!i.player)
									throw new Error("".concat(l, " Specified player is invalid."), i.enteredPlayer);
							} else {
							...
							t || !(s || (i.actions[i.actions.length - 1].reset && 0 === i.interactionIdx))
								? setTimeout(function () {
										n &&
											...
											l
												? l.call()
												: "none" === a && ((i.player.loop = !1), (i.player.autoplay = !1)),
											c && c.call(),
						...
						value: function () {
							...
							if (t)
								if ("seek" === t.type) {
									...
									if ("playOnce" === t.type && !i.scrolledAndPlayed)
										return (
											(i.scrolledAndPlayed = !0),
											i.player.resetSegments(!0),
											void (t.frames ? i.player.playSegments(t.frames, !0) : i.player.play())
										);
									"play" === t.type &&
										i.player.isPaused &&
										(i.player.resetSegments(!0),
						...
						value: function () {
							this.actions && 1 === this.actions.length
								? "click" === this.actions[0].type
									...
									? ((this.player.loop = !1),
									  this.player.stop(),
									  this.container.addEventListener("mouseenter", o(this, h)),
									  this.container.addEventListener("touchstart", o(this, h), { passive: !0 }))
						...
						value: function () {
							if (
								...
								"cursor" === this.mode &&
									...
									this.container.removeEventListener("mouseenter", o(this, h)),
									this.container.removeEventListener("touchstart", o(this, h)),
